...
def bot_response_function(user_message, chat_history):
    ...
    (Customer Segments,Value Propositions,Channels,Customer Relationships,Revenue Streams,Key Resources, Key Partnerships, Key Processes, Cost Structure)
    ...
    chatbot_prompt = f"""
    You are a senior expert on startup business model design. You are given a startup name and you need to generate the startup business model canvas (Customer Segments,Value Propositions,Channels,Customer Relationships,Revenue Streams,Key Resources, Key Partnerships, Key Processes, Cost Structure) for that startup.

    respond to this {user_message} following these instructions:

    ## Instructions:
    * be very concise
    * always start with WOW! This is an amazing YC-backed startup!
    * then say something insightful after your concise description of the startup business model canvas (no more than 50 words).
    * Ground all your answers based on this framework {external_knowledge} and make sure you cover all the elements of the canvas.
    """
...
if __name__ == "__main__":
    ...
    if args.option == 1:
        ...
        prompt = "generate the startup business model canvas (Customer Segments,Value Propositions,Channels,Customer Relationships,Revenue Streams,Key Resources, Key Partnerships, Key Processes, Cost Structure) for Airbnb (no more than 50 words)"
        ...
        prompt = "Create an image of the startup business model canvas (Customer Segments,Value Propositions,Channels,Customer Relationships,Revenue Streams,Key Resources, Key Partnerships, Key Processes, Cost Structure) for Airbnb(no more than 6 words per element)"
        ...
        text_prompt = "generate the startup business model canvas (Customer Segments,Value Propositions,Channels,Customer Relationships,Revenue Streams,Key Resources, Key Partnerships, Key Processes, Cost Structure) for DoorDash"
        ...
        with gr.Blocks(theme=gr.themes.Soft()) as app:
            ...
            gr.Markdown("Enter a YC-backed startup name below and let the chatbot respond!")

            chatbot = gr.Chatbot()
            image_output = gr.Image(label="Generated Image")
            user_input = gr.Textbox(
                placeholder="Type a startup name here...", label="Startup Name"
            )
